...
double calculateVertexSharedTracksMomentumSum(const reco::Vertex& recoV, const TrackingVertex& simV, const reco::RecoToSimCollection& trackRecoToSimAssociation, std::string sumType) {
...
double calculateVertexSharedTracksMomentumSum(const TrackingVertex& simV, const reco::Vertex& recoV, const reco::SimToRecoCollection& trackSimToRecoAssociation, std::string sumType) {
  double sharedMomentumSum = 0;
